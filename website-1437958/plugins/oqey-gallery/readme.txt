...
Tags: gallery, slideshow, image, music, fullscreen, html5, iphone, ipad
...
For more details, html5 skins, flash skins and examples, please visit <a href="http://oqeysites.com/" title="oQeySites">oqeysites.com</a> 

NOTE: If you encounter problems with the gallery, please disable and enable the plugin manually.

Features:

* NEW: Html5 fullscreen skin is available
* Wordpress uploader is native now for oQey Gallery
* Wordpress media files support
* Free 100% Html 5 skin is available - Veronika's skin
...
=1.0.7=
* New html 5 skin support
* Stability improvements
* Loading optimizations (lazy load)
* New options 
...
* Wordpress native galleries now can use oQey Skins
* New options on settings page
* Stability improvements
...
* Javascript slideshow progressive loading added
* Few minor bugs fixed
...
* Responsive skins via CSS
* New option for gallery width
* New roles restriction. Only administrator can edit all galleries.
